...
import pageObject.TripConfirmationPage;
import pageObject.TruckCategoryandSchedule;
import resources.WebLaunch;

public class TripConfirmationTest extends WebLaunch{
	
	@Test
	public  void tripView() throws IOException, InterruptedException 
    {
        ...
        TripConfirmationPage   trip = new  TripConfirmationPage  ();
        trip.Tripidview(driver);
        trip.paymentview(driver, null  );
